                    ...
                    <div class="navbar-custom-menu">
                        <ul class="nav navbar-nav">
                            ...
                            <li class="dropdown user user-menu">
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                    <img src="${pageContext.request.contextPath}/test/dist/img/user2-160x160.jpg" class="user-image" alt="User Image">
                                    <span class="hidden-xs"><% out.println(p.getNome());%></span>
                                </a>
                                <ul class="dropdown-menu">
                                    <!-- User image -->
                                    <li class="user-header">
                                        <img src="${pageContext.request.contextPath}/test/dist/img/user2-160x160.jpg" class="img-circle" alt="User Image">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="treeview">
                            ...
                            <ul class="treeview-menu">
                                <li><a href="pages/examples/invoice.html"><i class="fa fa-circle-o"></i> Reserva Semestral</a></li>
                                <li><a href="pages/examples/profile.html"><i class="fa fa-circle-o"></i> Reserva Pontual</a></li>
                            </ul>
                        </li>
                        <li class="treeview">
                            <a href="#">
                            ...
                            <ul class="treeview-menu">
                                <li><a href="pages/examples/invoice.html"><i class="fa fa-circle-o"></i> Reservas do Dia</a></li>
                                <li><a href="pages/examples/profile.html"><i class="fa fa-circle-o"></i> Todas as Reservas</a></li>
                            </ul>
                        </li>
                </section>
                <!-- /.sidebar -->
