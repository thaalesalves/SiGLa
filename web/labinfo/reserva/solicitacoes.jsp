                        ...
                        <div class="box-body">
                            <table id="example1" class="table table-bordered table-hover">
                                ...
                                <tbody>
                                    ...
                                    %>
                                    <tr class="gradeC">
                                        <td class="center"><% out.println(ares.get(ares.indexOf(r)).getTurma()); %></td>
                                        <td class="center"><% out.println(ares.get(ares.indexOf(r)).getCurso().getModalidade() + " em " + ares.get(ares.indexOf(r)).getCurso().getNome()); %></td>
                                        <td class="center"><% out.println(ares.get(ares.indexOf(r)).getSoftware().getFabricante() + " " + ares.get(ares.indexOf(r)).getSoftware().getNome()); %></td>
                                        <td class="center"><% out.println(ares.get(ares.indexOf(r)).getPessoa().getNome() + " " + ares.get(ares.indexOf(r)).getPessoa().getNomeCompleto().substring(ares.get(ares.indexOf(r)).getPessoa().getNomeCompleto().lastIndexOf(" ") + 1)); %></td>
                                        <td class="center"><% out.println(ares.get(ares.indexOf(r)).getModulo()); %></td>
                                        <td class="center"><% out.println(ares.get(ares.indexOf(r)).getObservacao()); %></td>
                                        <td class="center"><a href="javascript:showOptions()" class="fa fa-wrench"></a><span>&#32; &#32; &#32;</span><a href="${pageContext.request.contextPath}/AlmightyController?acao=RemoverReserva&reserva_id=<% out.println(ares.get(ares.indexOf(r)).getId()); %>" class="fa fa-close"></a></td>
                                    </tr>
                                    <% } %>
                                </tbody>
                            </table>
