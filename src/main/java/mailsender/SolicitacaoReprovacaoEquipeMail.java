...
public class SolicitacaoReprovacaoEquipeMail extends Mail {
    ...
    public String getMessage(Mail mail) {
        ...
        return "<!doctype html>\n"
                ...
                + "                        \n"
                + "                            <h1 style='text-align: center;'>Solicitação <strong>#" + mail.getSolicitacao().getId() + "</strong> reprovada</h1>\n"
                + "\n"
                + "                            <p style='text-align: center;'>A solicitação <strong>#" + mail.getSolicitacao().getId() + "</strong> foi recusada pois não foi possível atendê-la. O docente foi orientado a tentar outra data, e pode ser que contato seja feito.<br>\n"
                + "<br>\n"
