...
public class VencimentoTresDiasMail extends Mail {
    ...
    public String getMessage(Mail mail) {
        ...
        return "<!doctype html>\n"
                ...
                + "\n"
                + "                            <p style='text-align: center;'>A licença do software <strong>" + mail.getLicenca().getSoftware().getFabricante() + " " + mail.getLicenca().getSoftware().getNome() + "</strong> vence em 3 dias. Entre em contato com o fornecedor da licença para renová-la e adicione a nova licença adquirida ao software, ou o software será desativado em <strong>" + mail.getLicenca().getDataVencimento() + "</strong>.</p>\n"
                + "                        </td>\n"
                + "                    </tr>\n"
                + "                </tbody></table>\n"
                + "				<!--[if mso]>\n"
