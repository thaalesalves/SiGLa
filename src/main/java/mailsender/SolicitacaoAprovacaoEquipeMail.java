...
public class SolicitacaoAprovacaoEquipeMail extends Mail {
    ...
    public String getMessage(Mail mail) {
        ...
        return "<!doctype html>\n"
                ...
                + "                        \n"
                + "                            <h1 style='text-align: center;'>Solicitação <strong>#" + mail.getReserva().getId() + "</strong> aprovada</h1>\n"
                + "\n"
                + "                            <p style='text-align: center;'>A solicitação <strong>#" + mail.getReserva().getId() + "</strong> foi aprovada, e o laboratório <strong>" + mail.getReserva().getLab().getNumero() + "</strong> foi reservado!<br>\n"
                + "<br>\n"
                + "A reserva foi feita para o <strong>" + mail.getReserva().getTurma() + "</strong> de <strong>" + mail.getReserva().getCurso().getNome() + "</strong>, que tem <strong>" + mail.getReserva().getQtdAlunos() + " alunos, </strong>de <strong>" + mail.getReserva().getDiaDaSemana() + "</strong>, e foi registrada como reserva <strong>#" + mail.getReserva().getId() + "</strong>.</p>\n"
                + "\n"
