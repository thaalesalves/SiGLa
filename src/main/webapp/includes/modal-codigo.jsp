        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h5 class="modal-title soli-tit" id="solicitacao-modal-titulo">Adicionar código</h5>
                </div>     
                    ...
                    <div class="modal-body">
                        <table id="lista-codigos" cellpadding="0" cellspacing="0" border="0">
                            <tr>
                                <td>
                                    <div class="form-group">
                                        <label class="soli-tit">Licença #</label>
                                    </div>
                                </td>
                                <td style="width:100%;">
                                    <div class="form-group">
                            ...
                            <tr>
                                <td>
                                    <div class="form-group">
                                        <label class="soli-tit">Código</label>
                                    </div>
                                </td>
                                <td style="width:100%;">
                                    <div class="form-group">
                                        <input style="width: 80%;" type="text" class="form-control pull-right" name="chave" id="chave" placeholder="Código" />
                                    </div>
                                </td>
                            </tr>
                        </table>
