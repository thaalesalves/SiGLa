...
var aprovarReserva = function () {
    ...
    window.location.href = "/SiGLa_mvn/AlmightyController?acao=SolicitacaoAprovacao" + parameter;
};

var reprovarReserva = function () {
    window.location.href = "/SiGLa_mvn/AlmightyController?solicitacao_id=" + $("#modalIdSolicitacao").val() + "&acao=SolicitacaoRemocao";
};

var removerReserva = function () {
    window.location.href = "/SiGLa_mvn/AlmightyController?reserva_id=" + $("#modalIdSolicitacao").val() + "&acao=ReservaRemocao";
};
