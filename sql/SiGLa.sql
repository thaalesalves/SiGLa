...
INSERT INTO grupo VALUES (NEXTVAL('seq_grupo'), 'professor','memberOf=CN=sigla_prof,OU=AADDC Users,DC=thalesalv,DC=es');
INSERT INTO grupo VALUES (NEXTVAL('seq_grupo'), 'funcionario', 'memberOf=CN=sigla_func,OU=AADDC Users,DC=thalesalv,DC=es');
INSERT INTO grupo VALUES (NEXTVAL('seq_grupo'), 'estagiario', 'memberOf=CN=sigla_est,OU=AADDC Users,DC=thalesalv,DC=es');
INSERT INTO grupo VALUES (NEXTVAL('seq_grupo'), 'coordenador', 'memberOf=CN=sigla_coord,OU=AADDC Users,DC=thalesalv,DC=es');
INSERT INTO grupo VALUES (NEXTVAL('seq_grupo'), 'admin', 'memberOf=CN=sigla_admin,OU=AADDC Users,DC=thalesalv,DC=es');
